...
void Room3::Room3Init()
{
  //loads map file
  if(!map.load("Data/Room_3.tmx"))
  {
...
// Collision detections with play and certain tileID's
// If tiled.id == this { collision = false, room.transition = true} - Door change pseudocode
